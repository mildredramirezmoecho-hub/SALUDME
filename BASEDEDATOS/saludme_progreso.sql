...
CREATE TABLE `progreso` (
  ...
  CONSTRAINT `progreso_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Pacientes`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `progreso` VALUES (10,1,'2025-07-12',50.00,1.00,'1','1',22.22);
